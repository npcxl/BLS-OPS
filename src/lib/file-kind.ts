...
const KINDS: Record<string, Omit<FileKindInfo, "category"> & { category: FileCategory }> = {
  ...
  ods: { category: "sheet", icon: FileSpreadsheet, color: "text-green-500", label: "OpenDocument 表格" },
  odt: { category: "doc", icon: FileText, color: "text-blue-400", label: "OpenDocument 文档" },
  odp: { category: "doc", icon: FileText, color: "text-orange-400", label: "OpenDocument 演示" },
  rtf: { category: "doc", icon: FileText, color: "text-blue-300", label: "RTF" },
  ...
  jfif: { category: "image", icon: FileImage, color: "text-purple-400", label: "图片" },
  ...
  bmp: { category: "image", icon: FileImage, color: "text-purple-400", label: "位图" },
  avif: { category: "image", icon: FileImage, color: "text-purple-400", label: "图片" },
  tif: { category: "image", icon: FileImage, color: "text-purple-400", label: "TIFF" },
  tiff: { category: "image", icon: FileImage, color: "text-purple-400", label: "TIFF" },
  ...
  iso: { category: "archive", icon: FileArchive, color: "text-amber-400", label: "光盘镜像" },
  deb: { category: "archive", icon: FileArchive, color: "text-amber-400", label: "Debian 包" },
  rpm: { category: "archive", icon: FileArchive, color: "text-amber-400", label: "RPM 包" },
  mp4: { category: "video", icon: Film, color: "text-rose-400", label: "视频" },
  m4v: { category: "video", icon: Film, color: "text-rose-400", label: "视频" },
  ...
  webm: { category: "video", icon: Film, color: "text-rose-400", label: "视频" },
  flv: { category: "video", icon: Film, color: "text-rose-400", label: "视频" },
  mp3: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  wav: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  ogg: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  oga: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  m4a: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  aac: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  opus: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  flac: { category: "audio", icon: Music, color: "text-pink-400", label: "音频" },
  exe: { category: "binary", icon: FileIcon, color: "text-fg-subtle", label: "可执行程序" },
  dll: { category: "binary", icon: FileIcon, color: "text-fg-subtle", label: "动态库" },
  so: { category: "binary", icon: FileIcon, color: "text-fg-subtle", label: "动态库" },
  dylib: { category: "binary", icon: FileIcon, color: "text-fg-subtle", label: "动态库" },
  bin: { category: "binary", icon: FileIcon, color: "text-fg-subtle", label: "二进制文件" },
  db: { category: "binary", icon: Database, color: "text-neutral-300", label: "数据库" },
  sqlite: { category: "binary", icon: Database, color: "text-neutral-300", label: "SQLite" },
  sqlite3: { category: "binary", icon: Database, color: "text-neutral-300", label: "SQLite" },
};
